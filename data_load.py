...
def load_data():
   cur,conn=create_connection()
   titles_file = r"C:/Users/Nandini/OneDrive/Desktop/Dataset/titles.csv" # <- Replace with your path.
   titles_delimiter = "," # Replace if you're using a different delimiter.
   credits_file=r"C:/Users/Nandini/OneDrive/Desktop/Dataset/credits.csv"
   credits_delimiter=","
